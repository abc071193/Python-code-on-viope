...
If the user decides to remove something, the program informs the user about how many items there are on the list 
...
while True:
    ...
    select = int(input("(1)Add or\n(2)Remove items or\n(3)Quit?: "))

    if select == 1:
        mylist.append(input("What will be added?: "))
    elif select ==  2:
